import logoXeq from './assets/arqLogo.png'
const Navbar = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div className="container px-5">
                    ...
                    <a className="navbar-brand" href=""><img src={logoXeq} alt="" style={{width:"25px",marginTop:"-2px"}}/><span className="fw-bolder  medium text"> Arqma</span></a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 medium fw-bolder">
                            ...
                            <li className="nav-item"><a className="nav-link" href="https://arqma.github.io">Documentation</a></li>
